...
*Generated on 03/03/2026 at 22:33:29*
...
| `--background-feedback-notification` | `hsl(357.692 calc(1*67.826%) 54.902%/1)` | CSS |
...
| `--badge-background-default` | `hsl(240 calc(1*4%) 60.784%/0.1607843137254902)` | CSS |
| `--badge-expressive-background-default` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--badge-notification-background` | `hsl(357.692 calc(1*67.826%) 54.902%/1)` | CSS |
...
| `--checkbox-background-default` | `hsl(0 calc(1*0%) 0%/0.0784313725490196)` | CSS |
...
| `--guild-profile-banner-background-default` | `color-mix(in oklab,hsl(240 calc(1*5.263%) 7.451...` | CSS |
...
| `--progressbar-indicator-background` | `color-mix(in oklab,hsl(234.935 calc(1*85.556%) ...` | CSS |
| `--progressbar-track-background` | `color-mix(in oklab,hsl(240 calc(1*4%) 60.784%/0...` | CSS |
...
| `--slider-track-background` | `color-mix(in oklab,hsl(234 calc(1*6.579%) 29.80...` | CSS |
...
| `BADGE_BACKGROUND_DEFAULT` | `{}` | JS |
| `BADGE_NOTIFICATION_BACKGROUND` | `{}` | JS |
...
| `CONTROL_CONNECTED_BACKGROUND_ACTIVE` | `{}` | JS |
| `CONTROL_CONNECTED_BACKGROUND_DEFAULT` | `{}` | JS |
| `CONTROL_CRITICAL_PRIMARY_BACKGROUND_ACTIVE` | `{}` | JS |
| `CONTROL_CRITICAL_PRIMARY_BACKGROUND_DEFAULT` | `{}` | JS |
| `CONTROL_OVERLAY_PRIMARY_BACKGROUND_ACTIVE` | `{}` | JS |
| `CONTROL_OVERLAY_PRIMARY_BACKGROUND_DEFAULT` | `{}` | JS |
| `CONTROL_OVERLAY_SECONDARY_BACKGROUND_ACTIVE` | `{}` | JS |
| `CONTROL_OVERLAY_SECONDARY_BACKGROUND_DEFAULT` | `{}` | JS |
| `CONTROL_PRIMARY_BACKGROUND_ACTIVE` | `{}` | JS |
...
| `GUILD_PROFILE_BANNER_BACKGROUND_DEFAULT` | `{}` | JS |
...
| `MOBILE_LEGACY_BUTTON_SECONDARY_BACKGROUND_DEFAULT` | `{}` | JS |
...
| `PROGRESSBAR_INDICATOR_BACKGROUND` | `{}` | JS |
| `PROGRESSBAR_TRACK_BACKGROUND` | `{}` | JS |
...
| `--badge-text-default` | `hsl(0 calc(1*0%) 98.431%/1)` | CSS |
...
| `--steam-review-text-mixed` | `color-mix(in oklab,hsl(39.098 calc(1*100%) 47.8...` | CSS |
| `--steam-review-text-negative` | `color-mix(in oklab,hsl(1.314 calc(1*82.036%) 67...` | CSS |
| `--steam-review-text-positive` | `color-mix(in oklab,hsl(212.795 calc(1*82.564%) ...` | CSS |
...
| `--text-overlay-dark` | `hsl(230 calc(1*6%) 19.608%/1)` | CSS |
| `--text-overlay-light` | `hsl(0 calc(1*0%) 98.431%/1)` | CSS |
...
| `--text-voice-connected` | `color-mix(in oklab,hsl(140 calc(1*35.433%) 50.1...` | CSS |
| `--text-voice-disconnected` | `color-mix(in oklab,hsl(1.343 calc(1*84.81%) 69....` | CSS |
| `--text-voice-speaking` | `color-mix(in oklab,hsl(141.649 calc(1*44.292%) ...` | CSS |
| `BADGE_TEXT_DEFAULT` | `{}` | JS |
| `CONTENT_INVENTORY_OVERLAY_TEXT_PRIMARY` | `{}` | JS |
| `CONTENT_INVENTORY_OVERLAY_TEXT_SECONDARY` | `{}` | JS |
| `CONTROL_CONNECTED_TEXT_DEFAULT` | `{}` | JS |
| `CONTROL_CRITICAL_PRIMARY_TEXT_DEFAULT` | `{}` | JS |
| `CONTROL_OVERLAY_PRIMARY_TEXT_DEFAULT` | `{}` | JS |
| `CONTROL_OVERLAY_SECONDARY_TEXT_DEFAULT` | `{}` | JS |
...
| `MOBILE_LEGACY_BUTTON_SECONDARY_TEXT_DEFAULT` | `{}` | JS |
...
| `STEAM_REVIEW_TEXT_MIXED` | `{}` | JS |
| `STEAM_REVIEW_TEXT_NEGATIVE` | `{}` | JS |
| `STEAM_REVIEW_TEXT_POSITIVE` | `{}` | JS |
| `TEXT_BRAND` | `{}` | JS |
| `TEXT_DEFAULT` | `{}` | JS |
...
| `TEXT_STRONG` | `{}` | JS |
| `TEXT_SUBTLE` | `{}` | JS |
| `TEXT_VOICE_CONNECTED` | `{}` | JS |
| `TEXT_VOICE_DISCONNECTED` | `{}` | JS |
| `TEXT_VOICE_SPEAKING` | `{}` | JS |
...
| `MOBILE_LEGACY_BUTTON_SECONDARY_BORDER_DEFAULT` | `{}` | JS |
...
| `--checkbox-border-default` | `hsl(240 calc(1*4%) 60.784%/0.6392156862745098)` | CSS |
...
| `--control-secondary-border-active` | `color-mix(in oklab,hsl(240 calc(1*4%) 60.784%/0...` | CSS |
| `--control-secondary-border-default` | `color-mix(in oklab,hsl(240 calc(1*4%) 60.784%/0...` | CSS |
...
| `BORDER_FEEDBACK_CRITICAL` | `{}` | JS |
| `BORDER_FOCUS` | `{}` | JS |
| `BORDER_MUTED` | `{}` | JS |
| `BORDER_STRONG` | `{}` | JS |
| `BORDER_SUBTLE` | `{}` | JS |
| `CONTROL_CONNECTED_BORDER_DEFAULT` | `{}` | JS |
| `CONTROL_CRITICAL_PRIMARY_BORDER_DEFAULT` | `{}` | JS |
| `CONTROL_OVERLAY_PRIMARY_BORDER_DEFAULT` | `{}` | JS |
| `CONTROL_OVERLAY_SECONDARY_BORDER_DEFAULT` | `{}` | JS |
| `CONTROL_PRIMARY_BORDER_DEFAULT` | `{}` | JS |
| `CONTROL_SECONDARY_BORDER_ACTIVE` | `{}` | JS |
...
| `--guild-boosting-pink-refresh` | `hsl(315.084 calc(1*100%) 64.902%/1)` | CSS |
| `--guild-boosting-pink-refresh-hsl` | `315.084 calc(1*100%) 64.902%` | CSS |
...
| `GUILD_BOOSTING_PINK_REFRESH` | `#ff4cd2` | JS |
...
| `--tx-shadow-elevated` | `0 8px 16px rgba(0,0,0,0.24)` | CSS |
...
| `--radius-xs` | `4px` | CSS |
| `--radius-xxl` | `32px` | CSS |
| `--tx-radius-lg` | `8px` | CSS |
| `--tx-radius-md` | `4px` | CSS |
| `--tx-radius-sm` | `3px` | CSS |
...
| `--custom-emoji-picker-constants-diversity-emoji-container-padding-horizontal` | `7px` | CSS |
| `--custom-emoji-picker-constants-diversity-emoji-container-padding-vertical` | `7px` | CSS |
...
| `--chart-brand` | `color-mix(in oklab,hsl(234.935 calc(1*85.556%) ...` | CSS |
| `--chart-categorical-1` | `color-mix(in oklab,hsl(234.935 calc(1*85.556%) ...` | CSS |
| `--chart-categorical-10` | `color-mix(in oklab,hsl(34.395 calc(1*100%) 30.7...` | CSS |
| `--chart-categorical-2` | `color-mix(in oklab,hsl(25.532 calc(1*98.947%) 6...` | CSS |
| `--chart-categorical-3` | `color-mix(in oklab,hsl(268.462 calc(1*85.714%) ...` | CSS |
| `--chart-categorical-4` | `color-mix(in oklab,hsl(184.615 calc(1*46.614%) ...` | CSS |
| `--chart-categorical-5` | `color-mix(in oklab,hsl(138.353 calc(1*37.118%) ...` | CSS |
| `--chart-categorical-6` | `color-mix(in oklab,hsl(315.6 calc(1*64.103%) 54...` | CSS |
| `--chart-categorical-7` | `color-mix(in oklab,hsl(38.919 calc(1*98.93%) 63...` | CSS |
| `--chart-categorical-8` | `color-mix(in oklab,hsl(358.052 calc(1*68.75%) 5...` | CSS |
| `--chart-categorical-9` | `color-mix(in oklab,hsl(209.565 calc(1*100%) 27....` | CSS |
| `--chart-mono-1` | `color-mix(in oklab,hsl(230.4 calc(1*100%) 95.09...` | CSS |
| `--chart-mono-2` | `color-mix(in oklab,hsl(227.671 calc(1*100%) 85....` | CSS |
| `--chart-mono-3` | `color-mix(in oklab,hsl(229.655 calc(1*96.667%) ...` | CSS |
| `--chart-mono-4` | `color-mix(in oklab,hsl(232.966 calc(1*86.826%) ...` | CSS |
| `--chart-mono-5` | `color-mix(in oklab,hsl(232.941 calc(1*46.667%) ...` | CSS |
| `--chart-mono-6` | `color-mix(in oklab,hsl(230.37 calc(1*50.943%) 3...` | CSS |
| `--chart-mono-7` | `color-mix(in oklab,hsl(225 calc(1*64.865%) 14.5...` | CSS |
| `--chart-negative` | `color-mix(in oklab,hsl(355.636 calc(1*64.706%) ...` | CSS |
| `--chart-neutral` | `color-mix(in oklab,hsl(232.5 calc(1*3.96%) 60.3...` | CSS |
| `--chart-positive` | `color-mix(in oklab,hsl(138.353 calc(1*37.118%) ...` | CSS |
...
| `--icon-feedback-notification` | `hsl(357.692 calc(1*67.826%) 54.902%/1)` | CSS |
...
| `--icon-overlay-dark` | `color-mix(in oklab,hsl(230 calc(1*6%) 19.608%/1...` | CSS |
| `--icon-overlay-light` | `color-mix(in oklab,hsl(0 calc(1*0%) 98.431%/1) ...` | CSS |
...
| `--icon-voice-connected` | `color-mix(in oklab,hsl(140 calc(1*35.433%) 50.1...` | CSS |
| `--icon-voice-disconnected` | `color-mix(in oklab,hsl(1.343 calc(1*84.81%) 69....` | CSS |
| `--icon-voice-muted` | `hsl(357.692 calc(1*67.826%) 54.902%/1)` | CSS |
| `--icon-voice-speaking` | `color-mix(in oklab,hsl(141.649 calc(1*44.292%) ...` | CSS |
...
| `--spine-default` | `color-mix(in oklab,hsl(234 calc(1*6.579%) 29.80...` | CSS |
...
| `--tx-brand` | `hsl(234.935 calc(1*85.556%) 64.706%/1)` | CSS |
| `--tx-deleted-color` | `#f04747` | CSS |
| `--tx-edited-color` | `color-mix(in oklab,hsl(38.455 calc(1*100%) 43.1...` | CSS |
| `--tx-ghost-color` | `#faa61a` | CSS |
| `--tx-transition-fast` | `0.15s` | CSS |
| `--tx-transition-normal` | `0.2s` | CSS |
| `--tx-transition-slow` | `0.3s` | CSS |
| `--tx-z-menu` | `10002` | CSS |
| `--tx-z-modal` | `10000` | CSS |
| `--tx-z-viewer` | `10001` | CSS |
...
| `ICON_FEEDBACK_NOTIFICATION` | `{}` | JS |
| `ICON_FEEDBACK_POSITIVE` | `{}` | JS |
| `ICON_FEEDBACK_WARNING` | `{}` | JS |
| `ICON_MUTED` | `{}` | JS |
| `ICON_OVERLAY_DARK` | `{}` | JS |
| `ICON_OVERLAY_LIGHT` | `{}` | JS |
| `ICON_STRONG` | `{}` | JS |
| `ICON_SUBTLE` | `{}` | JS |
| `ICON_TRANSPARENT` | `{}` | JS |
| `ICON_VOICE_CONNECTED` | `{}` | JS |
| `ICON_VOICE_DISCONNECTED` | `{}` | JS |
| `ICON_VOICE_MUTED` | `{}` | JS |
| `ICON_VOICE_SPEAKING` | `{}` | JS |
...
*Total: 1144 variables*

---

## Summary

- **Total CSS Variables:** 4462
- **Total JS Constants:** 1951
- **Grand Total:** 6413
