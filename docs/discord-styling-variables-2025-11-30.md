...
*Generated on 01/12/2025 at 02:33:55*
...
| `--activity-card-background` | `color-mix(in oklab,hsl(240 calc(1*6.494%) 15.09...` | CSS |
| `--app-background-frame` | `color-mix(in oklab,hsl(240 calc(1*12.5%) 3.137%...` | CSS |
...
| `--background-mentioned` | `color-mix(in oklab,hsl(36.894 calc(1*100%) 31.5...` | CSS |
| `--background-mentioned-hover` | `color-mix(in oklab,hsl(36.894 calc(1*100%) 31.5...` | CSS |
| `--background-message-automod` | `color-mix(in oklab,hsl(1.417 calc(1*86.395%) 71...` | CSS |
| `--background-message-automod-hover` | `color-mix(in oklab,hsl(357.692 calc(1*67.826%) ...` | CSS |
| `--background-message-highlight` | `color-mix(in oklab,hsl(234.935 calc(1*85.556%) ...` | CSS |
| `--background-message-highlight-hover` | `color-mix(in oklab,hsl(234.935 calc(1*85.556%) ...` | CSS |
| `--background-message-hover` | `color-mix(in oklab,hsl(240 calc(1*4%) 60.784%/0...` | CSS |
| `--background-mobile-secondary` | `color-mix(in oklab,hsl(240 calc(1*6.452%) 12.15...` | CSS |
| `--background-mod-faint` | `hsl(240 calc(1*4%) 60.784%/0.0392156862745098)` | CSS |
...
| `--background-modifier-active` | `hsl(240 calc(1*4%) 60.784%/0.1607843137254902)` | CSS |
| `--background-modifier-hover` | `hsl(240 calc(1*4%) 60.784%/0.0784313725490196)` | CSS |
| `--background-modifier-selected` | `hsl(240 calc(1*4%) 60.784%/0.2)` | CSS |
| `--background-nested-floating` | `color-mix(in oklab,hsl(240 calc(1*6.383%) 9.216...` | CSS |
...
| `--badge-background-expressive` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
...
| `--bg-backdrop` | `color-mix(in oklab,hsl(0 calc(1*0%) 0%/0.7) 100...` | CSS |
| `--bg-backdrop-immersive` | `color-mix(in oklab,hsl(0 calc(1*0%) 0%/0.85) 10...` | CSS |
| `--bg-backdrop-no-opacity` | `color-mix(in oklab,hsl(0 calc(1*0%) 0%/1) 100%,...` | CSS |
| `--bg-brand` | `hsl(234.935 calc(1*85.556%) 64.706%/1)` | CSS |
...
| `--bg-surface-overlay` | `color-mix(in oklab,hsl(230 calc(1*6.383%) 18.43...` | CSS |
...
| `--button-creator-revenue-background` | `hsl(184.154 calc(1*95.588%) 26.667%/1)` | CSS |
| `--button-danger-background` | `hsl(355.636 calc(1*64.706%) 50%/1)` | CSS |
| `--button-danger-background-active` | `hsl(355.814 calc(1*64.824%) 39.02%/1)` | CSS |
| `--button-danger-background-disabled` | `hsl(355.636 calc(1*64.706%) 50%/1)` | CSS |
| `--button-danger-background-hover` | `hsl(356.143 calc(1*63.636%) 43.137%/1)` | CSS |
| `--button-expressive-background` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--button-expressive-background-active` | `hsl(240 calc(1*3.226%) 93.922%/1)` | CSS |
| `--button-expressive-background-hover` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--button-filled-brand-background` | `hsl(234.935 calc(1*85.556%) 64.706%/1)` | CSS |
| `--button-filled-brand-background-active` | `hsl(232 calc(1*47.511%) 43.333%/1)` | CSS |
| `--button-filled-brand-background-hover` | `hsl(233.115 calc(1*49.194%) 51.373%/1)` | CSS |
| `--button-filled-brand-inverted-background` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--button-filled-brand-inverted-background-active` | `hsl(230 calc(1*5%) 76.471%/1)` | CSS |
| `--button-filled-brand-inverted-background-hover` | `hsl(220 calc(1*4.918%) 88.039%/1)` | CSS |
| `--button-filled-white-background` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--button-filled-white-background-active` | `hsl(230 calc(1*5%) 76.471%/1)` | CSS |
| `--button-filled-white-background-hover` | `hsl(220 calc(1*4.918%) 88.039%/1)` | CSS |
| `--button-outline-brand-background` | `hsl(0 calc(1*0%) 100%/0)` | CSS |
| `--button-outline-brand-background-active` | `hsl(233.115 calc(1*49.194%) 51.373%/1)` | CSS |
| `--button-outline-brand-background-hover` | `hsl(234.935 calc(1*85.556%) 64.706%/1)` | CSS |
| `--button-outline-danger-background` | `hsl(240 calc(1*4%) 60.784%/0.12156862745098039)` | CSS |
| `--button-outline-danger-background-active` | `hsl(234.545 calc(1*6.509%) 33.137%/0.3)` | CSS |
| `--button-outline-danger-background-hover` | `hsl(240 calc(1*4%) 60.784%/0.2)` | CSS |
| `--button-outline-positive-background` | `hsl(0 calc(1*0%) 100%/0)` | CSS |
| `--button-outline-positive-background-active` | `hsl(144.944 calc(1*100%) 17.451%/1)` | CSS |
| `--button-outline-positive-background-hover` | `hsl(145.238 calc(1*95.455%) 25.882%/1)` | CSS |
| `--button-outline-primary-background` | `hsl(0 calc(1*0%) 100%/0)` | CSS |
| `--button-outline-primary-background-active` | `hsl(234 calc(1*4.386%) 44.706%/1)` | CSS |
| `--button-outline-primary-background-hover` | `hsl(234.545 calc(1*6.509%) 33.137%/1)` | CSS |
| `--button-positive-background` | `hsl(145.97 calc(1*100%) 26.275%/1)` | CSS |
| `--button-positive-background-active` | `hsl(144.545 calc(1*91.667%) 23.529%/1)` | CSS |
| `--button-positive-background-disabled` | `hsl(145.97 calc(1*100%) 26.275%/1)` | CSS |
| `--button-positive-background-hover` | `hsl(145.082 calc(1*93.846%) 25.49%/1)` | CSS |
| `--button-secondary-background` | `hsl(240 calc(1*4%) 60.784%/0.12156862745098039)` | CSS |
| `--button-secondary-background-active` | `hsl(234.545 calc(1*6.509%) 33.137%/0.3)` | CSS |
| `--button-secondary-background-disabled` | `hsl(240 calc(1*4%) 60.784%/0.12156862745098039)` | CSS |
| `--button-secondary-background-hover` | `hsl(240 calc(1*4%) 60.784%/0.2)` | CSS |
| `--button-transparent-background` | `hsl(240 calc(1*4%) 60.784%/0.12156862745098039)` | CSS |
| `--button-transparent-background-active` | `hsl(234.545 calc(1*6.509%) 33.137%/0.3)` | CSS |
| `--button-transparent-background-hover` | `hsl(240 calc(1*4%) 60.784%/0.2)` | CSS |
...
| `--checkbox-background-checked` | `color-mix(in oklab,hsl(234.935 calc(1*85.556%) ...` | CSS |
| `--checkbox-background-default` | `hsl(240 calc(1*4%) 60.784%/0.0392156862745098)` | CSS |
| `--checkbox-background-default-selected` | `hsl(234.935 calc(1*85.556%) 64.706%/1)` | CSS |
| `--checkbox-background-hover` | `hsl(0 calc(1*0%) 0%/0.0784313725490196)` | CSS |
| `--checkbox-background-hover-selected` | `hsl(232.941 calc(1*46.667%) 50%/1)` | CSS |
...
| `--context-menu-backdrop-background` | `color-mix(in oklab,hsl(0 calc(1*0%) 0%/0.7) 100...` | CSS |
| `--control-background-active-active` | `hsl(145.2 calc(1*96.154%) 20.392%/1)` | CSS |
| `--control-background-active-default` | `hsl(145.97 calc(1*100%) 26.275%/1)` | CSS |
| `--control-background-active-hover` | `hsl(144.522 calc(1*92%) 24.51%/1)` | CSS |
| `--control-background-active-loading` | `hsl(145.97 calc(1*100%) 26.275%/1)` | CSS |
| `--control-background-critical-primary-active` | `hsl(355.714 calc(1*64.948%) 38.039%/1)` | CSS |
| `--control-background-critical-primary-default` | `hsl(355.636 calc(1*64.706%) 50%/1)` | CSS |
| `--control-background-critical-primary-hover` | `hsl(355.51 calc(1*64.192%) 44.902%/1)` | CSS |
| `--control-background-critical-primary-loading` | `hsl(355.636 calc(1*64.706%) 50%/1)` | CSS |
| `--control-background-critical-secondary-active` | `hsl(240 calc(1*4%) 60.784%/0.2)` | CSS |
| `--control-background-critical-secondary-default` | `hsl(240 calc(1*4%) 60.784%/0.0784313725490196)` | CSS |
| `--control-background-critical-secondary-hover` | `hsl(240 calc(1*4%) 60.784%/0.1607843137254902)` | CSS |
| `--control-background-critical-secondary-loading` | `hsl(240 calc(1*4%) 60.784%/0.0784313725490196)` | CSS |
| `--control-background-expressive-active` | `hsl(225 calc(1*5.882%) 86.667%/1)` | CSS |
| `--control-background-expressive-default` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--control-background-expressive-hover` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--control-background-expressive-loading` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--control-background-icon-only-active` | `hsl(240 calc(1*4%) 60.784%/0.2)` | CSS |
| `--control-background-icon-only-hover` | `hsl(240 calc(1*4%) 60.784%/0.1607843137254902)` | CSS |
| `--control-background-overlay-primary-active` | `hsl(230 calc(1*5%) 76.471%/1)` | CSS |
| `--control-background-overlay-primary-default` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--control-background-overlay-primary-hover` | `hsl(220 calc(1*4.918%) 88.039%/1)` | CSS |
| `--control-background-overlay-primary-loading` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--control-background-overlay-secondary-active` | `hsl(0 calc(1*0%) 0%/0.47843137254901963)` | CSS |
| `--control-background-overlay-secondary-default` | `hsl(0 calc(1*0%) 0%/0.5215686274509804)` | CSS |
| `--control-background-overlay-secondary-hover` | `hsl(0 calc(1*0%) 0%/0.6392156862745098)` | CSS |
| `--control-background-overlay-secondary-loading` | `hsl(0 calc(1*0%) 0%/0.5215686274509804)` | CSS |
| `--control-background-primary-active` | `hsl(232 calc(1*47.511%) 43.333%/1)` | CSS |
| `--control-background-primary-default` | `hsl(234.935 calc(1*85.556%) 64.706%/1)` | CSS |
| `--control-background-primary-hover` | `hsl(232.941 calc(1*46.667%) 50%/1)` | CSS |
| `--control-background-primary-loading` | `hsl(234.935 calc(1*85.556%) 64.706%/1)` | CSS |
| `--control-background-secondary-active` | `hsl(240 calc(1*4%) 60.784%/0.2)` | CSS |
| `--control-background-secondary-default` | `hsl(240 calc(1*4%) 60.784%/0.0784313725490196)` | CSS |
| `--control-background-secondary-hover` | `hsl(240 calc(1*4%) 60.784%/0.1607843137254902)` | CSS |
...
| `--info-box-background` | `color-mix(in oklab,hsl(213.333 calc(1*81.818%) ...` | CSS |
| `--info-positive-background` | `color-mix(in oklab,hsl(145.97 calc(1*100%) 26.2...` | CSS |
| `--input-background` | `color-mix(in oklab,hsl(0 calc(1*0%) 0%/0.078431...` | CSS |
| `--input-background-critical` | `color-mix(in oklab,hsl(355.636 calc(1*64.706%) ...` | CSS |
| `--input-background-default` | `color-mix(in oklab,hsl(0 calc(1*0%) 0%/0.121568...` | CSS |
| `--input-error-background` | `color-mix(in oklab,hsl(355.814 calc(1*64.824%) ...` | CSS |
| `--mention-background` | `color-mix(in oklab,hsl(234.935 calc(1*85.556%) ...` | CSS |
| `--message-reacted-background` | `color-mix(in oklab,hsl(234.935 calc(1*85.556%) ...` | CSS |
...
| `--status-danger-background` | `hsl(356.625 calc(1*66.116%) 52.549%/1)` | CSS |
...
| `--switch-background-default-selected` | `hsl(234.935 calc(1*85.556%) 64.706%/1)` | CSS |
| `--switch-background-hover` | `hsl(0 calc(1*0%) 0%/0.12156862745098039)` | CSS |
| `--switch-background-hover-selected` | `hsl(232.941 calc(1*46.667%) 50%/1)` | CSS |
| `--switch-thumb-background-default` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--switch-thumb-background-default-selected` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
...
| `BACKGROUND_FLOATING` | `{}` | JS |
| `BACKGROUND_MENTIONED` | `{}` | JS |
| `BACKGROUND_MENTIONED_HOVER` | `{}` | JS |
| `BACKGROUND_MESSAGE_AUTOMOD` | `{}` | JS |
| `BACKGROUND_MESSAGE_AUTOMOD_HOVER` | `{}` | JS |
| `BACKGROUND_MESSAGE_HIGHLIGHT` | `{}` | JS |
| `BACKGROUND_MESSAGE_HIGHLIGHT_HOVER` | `{}` | JS |
| `BACKGROUND_MESSAGE_HOVER` | `{}` | JS |
| `BACKGROUND_MOBILE_PRIMARY` | `{}` | JS |
| `BACKGROUND_MOBILE_SECONDARY` | `{}` | JS |
| `BACKGROUND_MODIFIER_ACCENT` | `{}` | JS |
| `BACKGROUND_MODIFIER_ACTIVE` | `{}` | JS |
| `BACKGROUND_MODIFIER_HOVER` | `{}` | JS |
| `BACKGROUND_MODIFIER_SELECTED` | `{}` | JS |
| `BACKGROUND_NESTED_FLOATING` | `{}` | JS |
| `BACKGROUND_PRIMARY` | `{}` | JS |
| `BACKGROUND_SECONDARY` | `{}` | JS |
| `BACKGROUND_SECONDARY_ALT` | `{}` | JS |
| `BACKGROUND_TERTIARY` | `{}` | JS |
...
| `BG_BACKDROP` | `{}` | JS |
| `BG_BACKDROP_IMMERSIVE` | `{}` | JS |
| `BG_BACKDROP_NO_OPACITY` | `{}` | JS |
| `BG_BASE_PRIMARY` | `{}` | JS |
| `BG_BASE_SECONDARY` | `{}` | JS |
| `BG_BASE_TERTIARY` | `{}` | JS |
| `BG_BRAND` | `{}` | JS |
...
| `BG_MOD_STRONG` | `{}` | JS |
| `BG_MOD_SUBTLE` | `{}` | JS |
| `BG_SURFACE_OVERLAY` | `{}` | JS |
| `BG_SURFACE_OVERLAY_TMP` | `{}` | JS |
| `BG_SURFACE_RAISED` | `{}` | JS |
| `BUG_REPORTER_MODAL_SUBMITTING_BACKGROUND` | `{}` | JS |
| `BUTTON_CREATOR_REVENUE_BACKGROUND` | `{}` | JS |
| `BUTTON_DANGER_BACKGROUND` | `{}` | JS |
| `BUTTON_DANGER_BACKGROUND_ACTIVE` | `{}` | JS |
| `BUTTON_DANGER_BACKGROUND_DISABLED` | `{}` | JS |
| `BUTTON_DANGER_BACKGROUND_HOVER` | `{}` | JS |
| `BUTTON_OUTLINE_BRAND_BACKGROUND` | `{}` | JS |
| `BUTTON_OUTLINE_BRAND_BACKGROUND_ACTIVE` | `{}` | JS |
| `BUTTON_OUTLINE_BRAND_BACKGROUND_HOVER` | `{}` | JS |
| `BUTTON_OUTLINE_POSITIVE_BACKGROUND` | `{}` | JS |
| `BUTTON_OUTLINE_POSITIVE_BACKGROUND_ACTIVE` | `{}` | JS |
| `BUTTON_OUTLINE_POSITIVE_BACKGROUND_HOVER` | `{}` | JS |
| `BUTTON_OUTLINE_PRIMARY_BACKGROUND` | `{}` | JS |
| `BUTTON_OUTLINE_PRIMARY_BACKGROUND_ACTIVE` | `{}` | JS |
| `BUTTON_OUTLINE_PRIMARY_BACKGROUND_HOVER` | `{}` | JS |
| `BUTTON_POSITIVE_BACKGROUND` | `{}` | JS |
| `BUTTON_POSITIVE_BACKGROUND_ACTIVE` | `{}` | JS |
| `BUTTON_POSITIVE_BACKGROUND_DISABLED` | `{}` | JS |
| `BUTTON_POSITIVE_BACKGROUND_HOVER` | `{}` | JS |
| `BUTTON_SECONDARY_BACKGROUND` | `{}` | JS |
| `BUTTON_SECONDARY_BACKGROUND_ACTIVE` | `{}` | JS |
| `BUTTON_SECONDARY_BACKGROUND_HOVER` | `{}` | JS |
...
| `INFO_BOX_BACKGROUND` | `{}` | JS |
| `INFO_DANGER_BACKGROUND` | `{}` | JS |
| `INFO_HELP_BACKGROUND` | `{}` | JS |
| `INFO_POSITIVE_BACKGROUND` | `{}` | JS |
| `INFO_WARNING_BACKGROUND` | `{}` | JS |
| `INPUT_BACKGROUND` | `{}` | JS |
| `INPUT_ERROR_BACKGROUND` | `{}` | JS |
| `MENTION_BACKGROUND` | `{}` | JS |
| `MESSAGE_REACTED_BACKGROUND` | `{}` | JS |
| `MODAL_BACKGROUND` | `{}` | JS |
...
| `--badge-text-expressive` | `hsl(230 calc(1*6%) 19.608%/1)` | CSS |
| `--button-outline-brand-text-active` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--button-outline-brand-text-hover` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--button-outline-danger-text-active` | `hsl(1.417 calc(1*86.395%) 71.176%/1)` | CSS |
| `--button-outline-danger-text-hover` | `hsl(1.417 calc(1*86.395%) 71.176%/1)` | CSS |
| `--button-outline-positive-text-active` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--button-outline-positive-text-hover` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--button-outline-primary-text-active` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--button-outline-primary-text-hover` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
...
| `--control-text-active-active` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--control-text-active-default` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--control-text-active-hover` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--control-text-active-loading` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--control-text-critical-primary-active` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--control-text-critical-primary-default` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--control-text-critical-primary-hover` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--control-text-critical-primary-loading` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--control-text-critical-secondary-active` | `hsl(1.353 calc(1*82.609%) 68.431%/1)` | CSS |
| `--control-text-critical-secondary-default` | `hsl(1.353 calc(1*82.609%) 68.431%/1)` | CSS |
| `--control-text-critical-secondary-hover` | `hsl(1.353 calc(1*82.609%) 68.431%/1)` | CSS |
| `--control-text-critical-secondary-loading` | `hsl(1.353 calc(1*82.609%) 68.431%/1)` | CSS |
| `--control-text-expressive-active` | `hsl(0 calc(1*0%) 0%/1)` | CSS |
| `--control-text-expressive-default` | `hsl(0 calc(1*0%) 0%/1)` | CSS |
| `--control-text-expressive-hover` | `hsl(0 calc(1*0%) 0%/1)` | CSS |
| `--control-text-expressive-loading` | `hsl(0 calc(1*0%) 0%/1)` | CSS |
| `--control-text-overlay-primary-active` | `hsl(0 calc(1*0%) 0%/1)` | CSS |
| `--control-text-overlay-primary-default` | `hsl(0 calc(1*0%) 0%/1)` | CSS |
| `--control-text-overlay-primary-hover` | `hsl(0 calc(1*0%) 0%/1)` | CSS |
| `--control-text-overlay-primary-loading` | `hsl(0 calc(1*0%) 0%/1)` | CSS |
| `--control-text-overlay-secondary-active` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--control-text-overlay-secondary-default` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--control-text-overlay-secondary-hover` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--control-text-overlay-secondary-loading` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--control-text-primary-active` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--control-text-primary-default` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--control-text-primary-hover` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--control-text-primary-loading` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--control-text-secondary-active` | `hsl(0 calc(1*0%) 98.431%/1)` | CSS |
| `--control-text-secondary-default` | `hsl(0 calc(1*0%) 98.431%/1)` | CSS |
| `--control-text-secondary-hover` | `hsl(0 calc(1*0%) 98.431%/1)` | CSS |
...
| `--header-muted` | `color-mix(in oklab,hsl(232.5 calc(1*3.883%) 59....` | CSS |
| `--header-primary` | `color-mix(in oklab,hsl(0 calc(1*0%) 98.431%/1) ...` | CSS |
| `--header-secondary` | `color-mix(in oklab,hsl(240 calc(1*3.226%) 93.92...` | CSS |
...
| `--text-code-default` | `color-mix(in oklab,hsl(213.6 calc(1*85.034%) 71...` | CSS |
...
| `--text-danger` | `color-mix(in oklab,hsl(1.417 calc(1*86.395%) 71...` | CSS |
...
| `--text-muted-on-default` | `color-mix(in oklab,hsl(240 calc(1*4.478%) 73.72...` | CSS |
| `--text-primary` | `color-mix(in oklab,hsl(0 calc(1*0%) 98.431%/1) ...` | CSS |
| `--text-secondary` | `color-mix(in oklab,hsl(240 calc(1*4.294%) 68.03...` | CSS |
| `--text-tertiary` | `color-mix(in oklab,hsl(232.5 calc(1*3.883%) 59....` | CSS |
| `BUTTON_OUTLINE_BRAND_TEXT_ACTIVE` | `{}` | JS |
| `BUTTON_OUTLINE_BRAND_TEXT_HOVER` | `{}` | JS |
| `BUTTON_OUTLINE_POSITIVE_TEXT_ACTIVE` | `{}` | JS |
| `BUTTON_OUTLINE_POSITIVE_TEXT_HOVER` | `{}` | JS |
| `BUTTON_OUTLINE_PRIMARY_TEXT_ACTIVE` | `{}` | JS |
| `BUTTON_OUTLINE_PRIMARY_TEXT_HOVER` | `{}` | JS |
...
| Variable | Value | Type |
|----------|-------|------|
| `--interactive-active` | `color-mix(in oklab,hsl(0 calc(1*0%) 98.431%/1) ...` | CSS |
| `--interactive-hover` | `color-mix(in oklab,hsl(0 calc(1*0%) 98.431%/1) ...` | CSS |
| `--interactive-muted` | `color-mix(in oklab,hsl(234.545 calc(1*6.509%) 3...` | CSS |
| `--interactive-normal` | `color-mix(in oklab,hsl(240 calc(1*4.294%) 68.03...` | CSS |
| `INTERACTIVE_ACTIVE` | `{}` | JS |
| `INTERACTIVE_HOVER` | `{}` | JS |
| `INTERACTIVE_MUTED` | `{}` | JS |
| `INTERACTIVE_NORMAL` | `{}` | JS |
...
| Variable | Value | Type |
|----------|-------|------|
| `--button-danger-border` | `hsl(0 calc(1*0%) 100%/0.0784313725490196)` | CSS |
| `--button-filled-brand-border` | `hsl(0 calc(1*0%) 100%/0.0784313725490196)` | CSS |
| `--button-filled-brand-inverted-text` | `hsl(0 calc(1*0%) 0%/1)` | CSS |
| `--button-filled-brand-text` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--button-filled-white-text` | `hsl(0 calc(1*0%) 0%/1)` | CSS |
| `--button-outline-brand-border` | `hsl(234.935 calc(1*85.556%) 64.706%/1)` | CSS |
| `--button-outline-brand-border-active` | `hsl(233.115 calc(1*49.194%) 51.373%/1)` | CSS |
| `--button-outline-brand-border-hover` | `hsl(234.935 calc(1*85.556%) 64.706%/1)` | CSS |
| `--button-outline-brand-text` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--button-outline-danger-border` | `hsl(240 calc(1*4%) 60.784%/0.0392156862745098)` | CSS |
| `--button-outline-danger-border-active` | `hsl(240 calc(1*4%) 60.784%/0.0392156862745098)` | CSS |
| `--button-outline-danger-border-hover` | `hsl(240 calc(1*4%) 60.784%/0.0392156862745098)` | CSS |
| `--button-outline-danger-text` | `hsl(1.417 calc(1*86.395%) 71.176%/1)` | CSS |
| `--button-outline-positive-border` | `hsl(134.526 calc(1*41.485%) 44.902%/1)` | CSS |
| `--button-outline-positive-border-active` | `hsl(144.944 calc(1*100%) 17.451%/1)` | CSS |
| `--button-outline-positive-border-hover` | `hsl(145.238 calc(1*95.455%) 25.882%/1)` | CSS |
| `--button-outline-positive-text` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--button-outline-primary-border` | `hsl(234.545 calc(1*6.509%) 33.137%/1)` | CSS |
| `--button-outline-primary-border-active` | `hsl(234 calc(1*4.386%) 44.706%/1)` | CSS |
| `--button-outline-primary-border-hover` | `hsl(234.545 calc(1*6.509%) 33.137%/1)` | CSS |
| `--button-outline-primary-text` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--button-positive-border` | `hsl(0 calc(1*0%) 100%/0.0784313725490196)` | CSS |
| `--button-secondary-text` | `hsl(240 calc(1*5.263%) 92.549%/1)` | CSS |
| `--button-transparent-text` | `hsl(240 calc(1*5.263%) 92.549%/1)` | CSS |
...
| `BUTTON_OUTLINE_BRAND_BORDER` | `{}` | JS |
| `BUTTON_OUTLINE_BRAND_BORDER_ACTIVE` | `{}` | JS |
| `BUTTON_OUTLINE_BRAND_BORDER_HOVER` | `{}` | JS |
| `BUTTON_OUTLINE_BRAND_TEXT` | `{}` | JS |
| `BUTTON_OUTLINE_POSITIVE_BORDER` | `{}` | JS |
| `BUTTON_OUTLINE_POSITIVE_BORDER_ACTIVE` | `{}` | JS |
| `BUTTON_OUTLINE_POSITIVE_BORDER_HOVER` | `{}` | JS |
| `BUTTON_OUTLINE_POSITIVE_TEXT` | `{}` | JS |
| `BUTTON_OUTLINE_PRIMARY_BORDER` | `{}` | JS |
| `BUTTON_OUTLINE_PRIMARY_BORDER_ACTIVE` | `{}` | JS |
| `BUTTON_OUTLINE_PRIMARY_BORDER_HOVER` | `{}` | JS |
...
| `--checkbox-border-checked` | `color-mix(in oklab,hsl(234.935 calc(1*85.556%) ...` | CSS |
| `--checkbox-border-default` | `hsl(234 calc(1*4.386%) 44.706%/1)` | CSS |
| `--checkbox-border-default-selected` | `hsl(240 calc(1*4%) 60.784%/0.12156862745098039)` | CSS |
| `--checkbox-border-hover` | `hsl(240 calc(1*4%) 60.784%/0.8)` | CSS |
| `--checkbox-border-hover-selected` | `hsl(240 calc(1*4%) 60.784%/0.12156862745098039)` | CSS |
| `--checkbox-foreground-active` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
...
| `--input-border` | `color-mix(in oklab,hsl(240 calc(1*4%) 60.784%/0...` | CSS |
| `--input-border-active` | `color-mix(in oklab,hsl(234.935 calc(1*85.556%) ...` | CSS |
| `--input-border-critical` | `color-mix(in oklab,hsl(1.353 calc(1*82.609%) 68...` | CSS |
| `--input-border-critical-hover` | `color-mix(in oklab,hsl(357.692 calc(1*67.826%) ...` | CSS |
| `--input-border-default` | `color-mix(in oklab,hsl(0 calc(1*0%) 100%/0.2) 1...` | CSS |
| `--input-border-default-hover` | `color-mix(in oklab,hsl(240 calc(1*4%) 60.784%/0...` | CSS |
| `--input-border-read-only` | `color-mix(in oklab,hsl(0 calc(1*0%) 100%/0.0784...` | CSS |
| `--input-error-border` | `color-mix(in oklab,hsl(0 calc(1*74.737%) 62.745...` | CSS |
| `--input-error-text` | `color-mix(in oklab,hsl(2.609 calc(1*100%) 86.47...` | CSS |
| `--input-focused-border` | `color-mix(in oklab,hsl(234 calc(1*4.386%) 44.70...` | CSS |
| `--input-foreground-critical` | `color-mix(in oklab,hsl(240 calc(1*3.226%) 93.92...` | CSS |
| `--input-foreground-default` | `color-mix(in oklab,hsl(240 calc(1*3.226%) 93.92...` | CSS |
| `--input-foreground-icon` | `color-mix(in oklab,hsl(240 calc(1*4.294%) 68.03...` | CSS |
| `--input-foreground-placeholder` | `color-mix(in oklab,hsl(233.333 calc(1*3.529%) 5...` | CSS |
| `--input-placeholder-text` | `color-mix(in oklab,hsl(233.333 calc(1*3.529%) 5...` | CSS |
...
| `INPUT_BORDER` | `{}` | JS |
| `INPUT_BORDER_CRITICAL_HOVER` | `{}` | JS |
| `INPUT_ERROR_BORDER` | `{}` | JS |
| `INPUT_ERROR_TEXT` | `{}` | JS |
| `INPUT_FOCUSED_BORDER` | `{}` | JS |
| `INPUT_FOREGROUND_CRITICAL` | `{}` | JS |
| `INPUT_FOREGROUND_DEFAULT` | `{}` | JS |
| `INPUT_PLACEHOLDER_TEXT` | `{}` | JS |
...
| `--border-faint` | `color-mix(in oklab,hsl(240 calc(1*4%) 60.784%/0...` | CSS |
...
| `--control-border-active-active` | `hsl(0 calc(1*0%) 100%/0.0784313725490196)` | CSS |
| `--control-border-active-default` | `hsl(0 calc(1*0%) 100%/0.0784313725490196)` | CSS |
| `--control-border-active-hover` | `hsl(0 calc(1*0%) 100%/0.0784313725490196)` | CSS |
| `--control-border-active-loading` | `hsl(0 calc(1*0%) 100%/0.0784313725490196)` | CSS |
| `--control-border-critical-primary-active` | `hsl(0 calc(1*0%) 100%/0.0784313725490196)` | CSS |
| `--control-border-critical-primary-default` | `hsl(0 calc(1*0%) 100%/0.0784313725490196)` | CSS |
| `--control-border-critical-primary-hover` | `hsl(0 calc(1*0%) 100%/0.0784313725490196)` | CSS |
| `--control-border-critical-primary-loading` | `hsl(0 calc(1*0%) 100%/0.0784313725490196)` | CSS |
| `--control-border-critical-secondary-active` | `hsl(240 calc(1*4%) 60.784%/0.0392156862745098)` | CSS |
| `--control-border-critical-secondary-default` | `hsl(240 calc(1*4%) 60.784%/0.0392156862745098)` | CSS |
| `--control-border-critical-secondary-hover` | `hsl(240 calc(1*4%) 60.784%/0.0392156862745098)` | CSS |
...
| `--control-border-icon-only-active` | `hsl(240 calc(1*4%) 60.784%/0.0392156862745098)` | CSS |
| `--control-border-icon-only-hover` | `hsl(240 calc(1*4%) 60.784%/0.0392156862745098)` | CSS |
| `--control-border-overlay-primary-active` | `hsl(240 calc(1*4%) 60.784%/0.12156862745098039)` | CSS |
| `--control-border-overlay-primary-default` | `hsl(240 calc(1*4%) 60.784%/0.12156862745098039)` | CSS |
| `--control-border-overlay-primary-hover` | `hsl(240 calc(1*4%) 60.784%/0.12156862745098039)` | CSS |
| `--control-border-overlay-primary-loading` | `hsl(240 calc(1*4%) 60.784%/0.12156862745098039)` | CSS |
| `--control-border-overlay-secondary-active` | `hsl(240 calc(1*4%) 60.784%/0.0392156862745098)` | CSS |
| `--control-border-overlay-secondary-default` | `hsl(240 calc(1*4%) 60.784%/0.0392156862745098)` | CSS |
| `--control-border-overlay-secondary-hover` | `hsl(240 calc(1*4%) 60.784%/0.0392156862745098)` | CSS |
| `--control-border-overlay-secondary-loading` | `hsl(240 calc(1*4%) 60.784%/0.0392156862745098)` | CSS |
| `--control-border-primary-active` | `hsl(0 calc(1*0%) 100%/0.0784313725490196)` | CSS |
| `--control-border-primary-default` | `hsl(0 calc(1*0%) 100%/0.0784313725490196)` | CSS |
| `--control-border-primary-hover` | `hsl(0 calc(1*0%) 100%/0.0784313725490196)` | CSS |
| `--control-border-primary-loading` | `hsl(0 calc(1*0%) 100%/0.0784313725490196)` | CSS |
| `--control-border-secondary-active` | `hsl(240 calc(1*4%) 60.784%/0.0392156862745098)` | CSS |
| `--control-border-secondary-default` | `hsl(240 calc(1*4%) 60.784%/0.0392156862745098)` | CSS |
| `--control-border-secondary-hover` | `hsl(240 calc(1*4%) 60.784%/0.0392156862745098)` | CSS |
...
| `--divider-strong` | `color-mix(in oklab,hsl(234 calc(1*4.386%) 44.70...` | CSS |
| `--divider-subtle` | `color-mix(in oklab,hsl(234 calc(1*4.386%) 44.70...` | CSS |
...
| `--switch-border-default-selected` | `hsl(240 calc(1*4%) 60.784%/0.12156862745098039)` | CSS |
| `--switch-border-hover` | `hsl(240 calc(1*4%) 60.784%/0.4)` | CSS |
| `--switch-border-hover-selected` | `hsl(240 calc(1*4%) 60.784%/0.12156862745098039)` | CSS |
...
| `--status-dnd` | `hsl(357.692 calc(1*67.826%) 54.902%/1)` | CSS |
| `--status-idle` | `hsl(33.684 calc(1*53.774%) 58.431%/1)` | CSS |
| `--status-offline` | `hsl(232.5 calc(1*4%) 60.784%/1)` | CSS |
...
| Variable | Value | Type |
|----------|-------|------|
| `--badge-brand-bg` | `hsl(228.214 calc(1*100%) 89.02%/1)` | CSS |
| `--badge-brand-text` | `hsl(233.115 calc(1*49.194%) 51.373%/1)` | CSS |
...
| Variable | Value | Type |
|----------|-------|------|
| `--card-primary-bg` | `color-mix(in oklab,hsl(240 calc(1*6.494%) 15.09...` | CSS |
...
| `--control-icon-critical-primary-active` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--control-icon-critical-primary-default` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--control-icon-critical-primary-hover` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--control-icon-critical-primary-loading` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--control-icon-overlay-primary-active` | `hsl(0 calc(1*0%) 0%/1)` | CSS |
| `--control-icon-overlay-primary-default` | `hsl(0 calc(1*0%) 0%/1)` | CSS |
| `--control-icon-overlay-primary-hover` | `hsl(0 calc(1*0%) 0%/1)` | CSS |
| `--control-icon-overlay-primary-loading` | `hsl(0 calc(1*0%) 0%/1)` | CSS |
| `--control-icon-primary-active` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--control-icon-primary-default` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--control-icon-primary-hover` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
...
| Variable | Value | Type |
|----------|-------|------|
| `--activity-card-icon-overlay` | `color-mix(in oklab,hsl(231.429 calc(1*6.542%) 2...` | CSS |
...
| `--autocomplete-bg` | `color-mix(in oklab,hsl(240 calc(1*6.494%) 15.09...` | CSS |
...
| `--channelTabs-favHeight` | `28px` | CSS |
| `--channelTabs-openTabSize` | `24px` | CSS |
| `--channelTabs-tabHeight` | `32px` | CSS |
| `--channelTabs-tabNameFontSize` | `13px` | CSS |
| `--channelTabs-tabWidth` | `220px` | CSS |
| `--channelTabs-tabWidthMin` | `100px` | CSS |
...
| `--contrast` | `1` | CSS |
| `--control-icon-active-active` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--control-icon-active-default` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--control-icon-active-hover` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--control-icon-active-loading` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--control-icon-critical-secondary-active` | `hsl(1.353 calc(1*82.609%) 68.431%/1)` | CSS |
| `--control-icon-critical-secondary-default` | `hsl(1.353 calc(1*82.609%) 68.431%/1)` | CSS |
| `--control-icon-critical-secondary-hover` | `hsl(1.353 calc(1*82.609%) 68.431%/1)` | CSS |
| `--control-icon-critical-secondary-loading` | `hsl(1.353 calc(1*82.609%) 68.431%/1)` | CSS |
| `--control-icon-expressive-active` | `hsl(0 calc(1*0%) 0%/1)` | CSS |
| `--control-icon-expressive-default` | `hsl(0 calc(1*0%) 0%/1)` | CSS |
| `--control-icon-expressive-hover` | `hsl(0 calc(1*0%) 0%/1)` | CSS |
| `--control-icon-expressive-loading` | `hsl(0 calc(1*0%) 0%/1)` | CSS |
| `--control-icon-icon-only-active` | `hsl(0 calc(1*0%) 98.431%/1)` | CSS |
| `--control-icon-icon-only-default` | `hsl(240 calc(1*4.294%) 68.039%/1)` | CSS |
| `--control-icon-icon-only-hover` | `hsl(0 calc(1*0%) 98.431%/1)` | CSS |
| `--control-icon-icon-only-loading` | `hsl(0 calc(1*0%) 98.431%/1)` | CSS |
| `--control-icon-overlay-secondary-active` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--control-icon-overlay-secondary-default` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--control-icon-overlay-secondary-hover` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--control-icon-overlay-secondary-loading` | `hsl(0 calc(1*0%) 100%/1)` | CSS |
| `--control-icon-secondary-active` | `hsl(0 calc(1*0%) 98.431%/1)` | CSS |
| `--control-icon-secondary-default` | `hsl(0 calc(1*0%) 98.431%/1)` | CSS |
| `--control-icon-secondary-hover` | `hsl(0 calc(1*0%) 98.431%/1)` | CSS |
...
| `--focus-primary` | `color-mix(in oklab,hsl(213.333 calc(1*81.818%) ...` | CSS |
...
| `--icon-primary` | `color-mix(in oklab,hsl(0 calc(1*0%) 98.431%/1) ...` | CSS |
| `--icon-secondary` | `color-mix(in oklab,hsl(240 calc(1*4.294%) 68.03...` | CSS |
| `--icon-tertiary` | `color-mix(in oklab,hsl(232.5 calc(1*3.883%) 59....` | CSS |
...
| `--info-danger-foreground` | `color-mix(in oklab,hsl(357.692 calc(1*67.826%) ...` | CSS |
| `--info-help-foreground` | `color-mix(in oklab,hsl(213.333 calc(1*81.818%) ...` | CSS |
| `--info-positive-foreground` | `color-mix(in oklab,hsl(134.526 calc(1*41.485%) ...` | CSS |
| `--info-positive-text` | `color-mix(in oklab,hsl(132.809 calc(1*34.902%) ...` | CSS |
| `--info-warning-foreground` | `color-mix(in oklab,hsl(33.684 calc(1*53.774%) 5...` | CSS |
...
| `--menu-item-danger-active-bg` | `color-mix(in oklab,hsl(355.814 calc(1*64.824%) ...` | CSS |
...
| `--message-reacted-text` | `color-mix(in oklab,hsl(228 calc(1*100%) 86.275%...` | CSS |
...
| `--scrim-default` | `color-mix(in oklab,hsl(0 calc(1*0%) 0%/0.721568...` | CSS |
| `--scrim-lightbox` | `color-mix(in oklab,hsl(0 calc(1*0%) 0%/0.921568...` | CSS |
...
| `--switch-thumb-foreground-active` | `hsl(234.935 calc(1*85.556%) 64.706%/1)` | CSS |
| `--switch-thumb-foreground-default` | `hsl(230 calc(1*6%) 19.608%/1)` | CSS |
...
| `ACTION_SHEET_GRADIENT_BG` | `{}` | JS |
| `ACTIVITY_CARD_ICON_OVERLAY` | `{}` | JS |
| `ALERT_BG` | `{}` | JS |
| `ANDROID_RIPPLE` | `{}` | JS |
...
| `INFO_DANGER_FOREGROUND` | `{}` | JS |
| `INFO_DANGER_TEXT` | `{}` | JS |
| `INFO_HELP_FOREGROUND` | `{}` | JS |
| `INFO_HELP_TEXT` | `{}` | JS |
| `INFO_POSITIVE_FOREGROUND` | `{}` | JS |
| `INFO_POSITIVE_TEXT` | `{}` | JS |
| `INFO_WARNING_FOREGROUND` | `{}` | JS |
| `INFO_WARNING_TEXT` | `{}` | JS |
...
*Total: 1252 variables*

---

## Summary

- **Total CSS Variables:** 4755
- **Total JS Constants:** 2160
- **Grand Total:** 6915
